 ...
 *
 * ----------------------Notes----------------------
 * This library assumes the following pin configuration (7-0 bits) on the TIVA TM4C123H6PMI MCU
 * 7  6  5  4  3  2  1  0
...
//	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_5, 32); //Set Enable pin high - 00100000b
	...
	SysCtlDelay(0.3333333 * (CLOCK_FREQ*1000000) * (waitTime * 0.001) ); //Wait more than 37us (1ms)
